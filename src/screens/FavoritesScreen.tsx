...
export function FavoritesScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    closeIcon: { opacity: 0.9 },
    fullImage: { width: '100%', height: '60%' },
    modalInfo: { paddingHorizontal: 24, paddingTop: 16 },
    modalScoreRow: { flexDirection: 'row', alignItems: 'baseline', gap: 2 },
    modalScoreBadge: { flexDirection: 'row', alignItems: 'baseline', gap: 2 },
    modalScore: { color: colors.accent, fontSize: 32, fontWeight: '700' },
    modalScoreLabel: { color: colors.accent, fontSize: 18 },
    modalGrid: { color: colors.textSecondary, fontSize: 14, marginTop: 4 },
    modalDate: { color: colors.textSecondary, fontSize: 13, marginTop: 2 },
    modalSuggestion: { color: colors.text, fontSize: 13, marginTop: 12, lineHeight: 20 },
    sceneTagBadge: { backgroundColor: 'rgba(232,213,183,0.2)', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 2, alignSelf: 'flex-start', marginTop: 4 },
